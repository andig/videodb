...
$config['db_password']  = 'videodb';           // password for above user
$config['db_database']  = 'videodb-git';    // Database name
$config['db_prefix']    = 'videodb_';   // Database table prefix (for use in hosting environments)
/* 
// prod file
$config['db_server']    = 'localhost';  // database server
$config['db_user']      = 'videodb41-prod';    // DB user for connection
$config['db_password']  = 'videodb41-prod';           // password for above user
$config['db_database']  = 'videodb41-prod';    // Database name
$config['db_prefix']    = 'videodb_';   // Database table prefix (for use in hosting environments)
*/
...
// not sure this is now needed
//$config['pdf_module']       = './vendor/setasign/fpdf/';
...
$config['xls_extra_fields']    = 'title, plot, diskid, genres, mediatype, runtime, year, custom1, custom2, custom3, custom4';
/*
