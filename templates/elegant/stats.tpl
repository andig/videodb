{*
  ...
  $Id: stats.tpl,v 1.14 2009/04/04 16:27:13 andig2 Exp $
*}
...
{*
            ...
            <!-- ampie script-->
			<script type="text/javascript" src="./templates/elegant/amcharts/swfobject.js"></script>
			<script type="text/javascript">
			// <![CDATA[
				var so = new SWFObject("./templates/elegant/amcharts/amcolumn.swf", "amcolumn", "520", "200", "8", "#FFFFFF");
				so.addVariable("settings_file", escape("./templates/elegant/amcharts/amcolumn_settings.xml?{php}echo microtime();{/php}"));       // you can set two or more different settings files here (separated by commas)
			...
			<script type="text/javascript">
			// <![CDATA[
				var so = new SWFObject("./templates/elegant/amcharts/ampie.swf", "ampie", "520", "400", "8", "#FFFFFF");
				so.addVariable("settings_file", escape("./templates/elegant/amcharts/ampie_settings.xml?{php}echo microtime();{/php}"));       // you can set two or more different settings files here (separated by commas)
				so.addVariable("chart_data", "{$data}");                                          // you can pass chart data as a string directly from this file
